"""
v13: Attention U-Net + MultiScale Discriminator + HED Stain Loss + Cosine LR.
Based on v11 (best). Changes vs v11:
  - L1 lambda: 300 → 100 (reduce blurriness)
  - Discriminator: PatchGAN → MultiScaleDiscriminator
  - Generator: ResNet-34 U-Net → Attention U-Net (attention gates on skip connections)
  - Loss: + HED stain decomposition loss (λ=5)
  - LR schedule: flat → CosineAnnealingLR
  - Gradient penalty: applied to both disc scales
"""
import torch
...
class GANModuleV13(pl.LightningModule):
    def __init__(
        self,
        gen,
        disc,
