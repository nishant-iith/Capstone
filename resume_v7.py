"""
v7 training resume: Auto-resume from last checkpoint or start fresh.
...
def main():
    ...
    if ckpt_path.exists():
        ...
        trainer.fit(module, train_loader, val_loader, ckpt_path=str(ckpt_path))
    else:
